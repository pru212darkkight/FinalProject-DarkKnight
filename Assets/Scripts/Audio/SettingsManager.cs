...
public class SettingsManager : MonoBehaviour
{
    ...
    private void UpdateVolumeTexts()
    {
        ...
        {
            Debug.LogWarning("SettingsManager: sfxVolumeText or sfxVolumeSlider is null!");
        }
        ...
        {
            Debug.LogWarning("SettingsManager: musicVolumeText or musicVolumeSlider is null!");
        }
    }
